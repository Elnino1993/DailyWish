...
export function DailyMintPanel() {
  ...
  // Set receiver address to connected wallet by default
  useEffect(() => {
  ...
  useEffect(() => {
    const checkMintStatus = async () => {
      ...
      // Skip contract checks if not deployed
  ...
  // Show network switch alert if not on Arc Testnet
  ...
  // Show already minted today message
